...
function weekdays (weekStart) {
  ...
  var weekDays = luxon.Info.weekdays('short').map(function (weekday) { return capitalize$1(weekday); });
...
function months () {
  return luxon.Info.months().map(function (month) { return capitalize$1(month); })
}
